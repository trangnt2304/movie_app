...
class _RestClient implements RestClient {
  ...
  @override
  Future<ResponseData<List<MovieJson>>> getMovie() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<
        ResponseData<List<MovieJson>>>(Options(
            method: 'GET', headers: _headers, extra: _extra)
        .compose(_dio.options,
            'popular?api_key=e40e3108780dd1711cbbae5c9f2cfd52&language=en-US&page=1',
            queryParameters: queryParameters, data: _data)
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ResponseData<List<MovieJson>>.fromJson(
      _result.data!,
      (json) => (json as List<dynamic>)
          .map<MovieJson>((i) => MovieJson.fromJson(i as Map<String, dynamic>))
          .toList(),
    );
    return value;
  }
